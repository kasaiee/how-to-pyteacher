...
urlpatterns = [
    ...
    path('verify/<int:course_id>/', views.verify, name='verify'),
    path('<str:course_slug>/<str:session_slug>/', views.course_session_detail, name='course-session-detail'),
    path('<str:course_slug>/<str:session_slug>/<str:exercise_slug>/', views.course_session_exercise_detail, name='course-session-exercise-detail'),
